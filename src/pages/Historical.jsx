...
const Historical = () => {
  ...
  useEffect(() => {
    const fetchDefault = async () => {
      ...
      const res = await fetchHistoricalData(21.125, 79, sevenDaysAgo, today);
      const air = await fetchHistoricalAir(21.125, 79, sevenDaysAgo, today);
  ...
  const fetchData = async () => {
    ...
    setLoading(true);
    const res = await fetchHistoricalData(21.125, 79, startDate, endDate);
    const air = await fetchHistoricalAir(21.125, 79, startDate, endDate);
    setData({ weather: res, air });
    setLoading(false);
  };
  ...
  return (
    <div className="space-y-10">
      <div className="bg-gradient-to-r from-slate-900 to-blue-950 rounded-3xl p-8 text-white">
